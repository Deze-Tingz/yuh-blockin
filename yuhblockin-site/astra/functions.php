...
/**
 * YuhBlockin Landing Page Assets
 * Enqueue styles and scripts for the custom landing page template
 */
function yuhblockin_enqueue_landing_assets() {
	// Only load on pages using the YuhBlockin Home template
...
add_action( 'wp_enqueue_scripts', 'yuhblockin_enqueue_landing_assets' );

/**
 * Remove Astra header/footer on YuhBlockin landing page
 * (The template has its own header/footer)
 */
function yuhblockin_remove_theme_elements() {
	if ( is_page_template( 'page-yuhblockin-home.php' ) ) {
